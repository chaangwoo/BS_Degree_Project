...
#define MSHR_SIZE 99999999
#define MSHR_ENTRY_SIZE 99999999
//
...
public:
  ...
  uint64_t getTlbCycles()
  {
   ...
   uint64_t getMshrhits() //changed; BCCMshr -> Mshr
  {
    return mshrhits;
  }
  // changed
  ...
  uint64_t getNumReadHits()
  {
    return numReadHits;
  }
  uint64_t getNumReadMisses()
  {
    return numReadMisses;
  }
  uint64_t getNumWriteHits()
  {
    return numWriteHits;
  }
  uint64_t getNumWriteMisses()
  {
    return numWriteMisses;
  }
  DMAEngineHandle* getDmaDevice()
  {
    return dmaDevice;
  }
  // changed_stalling_mshr
