...
def define_options(parser):
    ...
    # // changed_addOptions
    parser.add_option("--mshr_entry", action="store", type="int", default=1,
                      help="number of entries in the fu's mshr.")
    parser.add_option("--mshr_width", action="store", type="int", default=1,
                      help="the width of each mshr entry; i.e., mshr[vp_base].")
    # //
