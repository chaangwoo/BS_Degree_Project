...
class LCAccDevice
{
  ...
  std::set<Action*> pendingReadActions;
  std::set<Action*> pendingComputeActions;
  std::set<Action*> pendingWriteActions;
  std::set<Action*> pendingRWActions;
  uint64_t readTimeStamp;
  uint64_t computeTimeStamp;
  uint64_t writeTimeStamp;
  uint64_t RWTimeStamp;
  uint64_t readActionTime;
  uint64_t computeActionTime;
  uint64_t writeActionTime;
  uint64_t RWActionTime;

  uint64_t numHandleTLBMissCall_0;
  uint64_t numHandleTLBMissCall_1;
  uint64_t numHandleTLBMissCall_2;
  //
...
public:
  ...
  uint64_t getComputeCycles()
  {
    return computeCycles;
  }
  uint64_t getWriteCycles()
  {
    return writeCycles;
  }
  ...
  {
    return readActionTime;
  }
  uint64_t getComputeActionTime()
  {
    return computeActionTime;
  }
  uint64_t getWriteActionTime()
  {
    return writeActionTime;
  }
  uint64_t getRWActionTime()
  {
    return RWActionTime;
  }

  uint64_t getNumHandleTLBMissCall_0()
  {
    return numHandleTLBMissCall_0;
  }
  uint64_t getNumHandleTLBMissCall_1()
  {
    return numHandleTLBMissCall_1;
  }
  uint64_t getNumHandleTLBMissCall_2()
  {
    return numHandleTLBMissCall_2;
  }
  //
};
}
